...
class TutorialCompletedS4C extends Phaser.Scene {
    constructor() {
        super({ key: 'TutorialCompletedS4C' });
    }
    ...
    create() {
      ...
      this.add.text(game.config.width/2, 220 ,'TRAINING COMPLETED', { fontSize: '40px', fill: '#37F121' }).setOrigin(0.5);
      ...
      practiceAgainButton.on('pointerdown', () => {
        this.scene.stop('TutorialS4C');
        this.scene.stop('TutorialCompletedS4C');
        this.scene.start('TutorialS4C');
      });
