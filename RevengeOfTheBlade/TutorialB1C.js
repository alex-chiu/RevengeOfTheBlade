...
// SCENE CLASS
class TutorialB1C extends Phaser.Scene {
    constructor() {
        super({ key: 'TutorialB1C' });
    }
    ...
    create() {
        ...
        // Create Dagger Group
        daggerGroup = new DaggerGroupTB1(this);
...
// Dagger Group Class
class DaggerGroupTB1 extends Phaser.Physics.Arcade.Group {
    constructor(scene) {
...
// Dagger Class
class DaggerTB1 extends Phaser.Physics.Arcade.Sprite {
