/*  TUTORIAL ENTRY INSTRUCTION SCENE
    ...
    Provides basic instructions to player regarding the controls of the game: when Boss4 is completed (B4C)
*/
...
class InstructionsB4C extends Phaser.Scene {
    constructor() {
        super({ key: 'InstructionsB4C' });
    }
    ...
    create() {
      ...
      playButton.on('pointerdown', () => {
        this.scene.stop('InstructionsB4C');
