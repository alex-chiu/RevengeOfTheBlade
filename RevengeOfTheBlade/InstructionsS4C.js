/*  TUTORIAL ENTRY INSTRUCTION SCENE
    ...
    Provides basic instructions to player regarding the controls of the game: when Stage 4 is completed (S4C)
*/
...
class InstructionsS4C extends Phaser.Scene {
    constructor() {
        super({ key: 'InstructionsS4C' });
    }
    ...
    create() {
      ...
      playButton.on('pointerdown', () => {
        this.scene.stop('InstructionsS4C');
