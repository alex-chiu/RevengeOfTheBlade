/*  MENU SCENE after boss4 completed

    Has options for entering the tutorial or starting the stage5.
*/

var stage5Button, tutorialButton, audioButton;
var soundState = 'off';

class MenuBoss4C extends Phaser.Scene {
    constructor() {
        super({ key: 'MenuBoss4C' });
    }
    ...
    create() {
      ...
      stage5Button = this.add.text(210,508,'Chromium Alloy Level', { fontSize: '30px', fill: '#02a3d9' });
      ...
      stage5Button.on('pointerover', () => { this.buttonOver(stage5Button); });
      stage5Button.on('pointerout', () => { this.buttonNotOver(stage5Button); });
    ...
    buttonOver(button) {
      if (button == stage5Button) {
        stage5Button.setStyle({fill:'#fffb00'});
      }
    ...
    buttonNotOver(button) {
      if (button == stage5Button) {
        stage5Button.setStyle({fill:'#02a3d9'})
      }
      if (button == tutorialButton) {
