...
class TutorialCompletedS5C extends Phaser.Scene {
    constructor() {
        super({ key: 'TutorialCompletedS5C' });
    }
    ...
    create() {
      ...
      practiceAgainButton.on('pointerdown', () => {
        this.scene.stop('TutorialS5C');
        this.scene.stop('TutorialCompletedS5C');
        this.scene.start('TutorialS5C');
      });
