...
class MenuStage1C extends Phaser.Scene {
    ...
    create() {
      ...
      // boss crosses
      // level 2 boss
      this.add.image(483, 460, 'cross');
      // level 3 boss
      this.add.image(460, 549, 'cross');
      ...
      boss1Button = this.add.text(316, 360, 'BOSS 1: Iron', { fontSize: '20px', fill: '#8db9d9' });
    ...
    buttonOver(button) {
      if (button == boss1Button) {
        boss1Button.setStyle({fill:'#37F121'});
      }
